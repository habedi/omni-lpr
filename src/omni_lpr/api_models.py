...
class ToolResponse(BaseModel):
    ...
    content: List[JsonContentBlock] = Field(..., description="A list of content blocks containing the tool's output.")
...
class ErrorBody(BaseModel):
    ...
    code: str = Field(..., description="A unique code for the error type (e.g., 'VALIDATION_ERROR').")
    message: str = Field(..., description="A high-level, human-readable error message.")
    details: Optional[List[ErrorDetail]] = Field(None, description="Optional list of specific validation errors.")
